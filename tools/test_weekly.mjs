...
assert.throws(()=>parseSource(html.replace('As of September 1, 2026','As of September 8, 2026'),new Date('2026-09-08T04:00:00Z')),/dates disagree/);
assert.throws(()=>parseSource(html.replace('83.24','N/A').replace('84.62','N/A').replace('86.22','N/A'),new Date('2026-09-07T04:00:00Z')),/Insufficient/);
